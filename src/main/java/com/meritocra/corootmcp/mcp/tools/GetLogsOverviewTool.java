...
@Component
public class GetLogsOverviewTool implements McpTool {
	...
	public GetLogsOverviewTool(CorootClient corootClient, CorootProperties properties, ObjectMapper objectMapper) {
	...
	public ToolDefinition definition() {
		...
		query.put("description",
				"Optional log query string as you would enter it in the Coroot logs overview.");

		schema.put("additionalProperties", false);

		return new ToolDefinition("get_logs_overview",
				"Returns a logs overview for a Coroot project, aligned with the Logs overview in Coroot.",
				schema);
	}
	...
	public ObjectNode call(ObjectNode arguments) {
		...
		Map<String, Object> overview = corootClient.getLogsOverview(projectId, query);
