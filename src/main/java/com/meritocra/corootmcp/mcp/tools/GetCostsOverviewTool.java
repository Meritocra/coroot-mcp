...
@Component
public class GetCostsOverviewTool implements McpTool {
	...
	public GetCostsOverviewTool(CorootClient corootClient, CorootProperties properties, ObjectMapper objectMapper) {
	...
	public ToolDefinition definition() {
		...
		return new ToolDefinition("get_costs_overview",
				"Returns a cost overview for a Coroot project, aligned with the Costs overview in Coroot.",
				schema);
	}
	...
	public ObjectNode call(ObjectNode arguments) {
		...
		Map<String, Object> overview = corootClient.getCostsOverview(projectId);
